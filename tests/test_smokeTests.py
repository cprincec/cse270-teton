...
class TestSmokeTests():
  ...
  def test_homePageTest(self):
    ...
    self.driver.set_window_size(652, 752)
  ...
  def test_adminPageTests(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").click()
    self.driver.find_element(By.ID, "username").send_keys("waing ")
    self.driver.find_element(By.ID, "password").send_keys("wanih")
  ...
  def test_directoryPageTests(self):
    ...
    self.driver.set_window_size(1038, 752)
  ...
  def test_joinPageTests(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Prince")
    self.driver.find_element(By.NAME, "lname").send_keys("Chukwu")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Global Enterprise Solutions and Internat")
